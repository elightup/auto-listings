	...
	class Cmb2GridPlugin extends DesignPatterns\Singleton {
		...
		public function wpHead() {
			...
			<style>
				...
				.cmb2GridRow .cmb-repeat-groal-wrap{max-width:100% !important;}
				.cmb2GridRow .cmb-groal-title{margin:0 !important;}
				.cmb2GridRow .cmb-repeat-groal-wrap .cmb-row .cmbhandle, .cmb2GridRow .postbox-container .cmb-row .cmbhandle{right:0 !important}
			</style>
			<?php
