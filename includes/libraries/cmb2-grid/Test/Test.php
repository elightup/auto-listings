...
if ( ! class_exists( '\Cmb2Grid\Test\Test' ) ) {
	...
	class Test {
		...
		public function testGroupCmb() {
			...
			$field1		 = $cmb_groal->add_field( array(
				'name'	 => __( 'Test Text', 'cmb2' ),
				'desc'	 => __( 'field description (optional)', 'cmb2' ),
				'id'	 => $prefix . 'text',
				'type'	 => 'text',
			) );
			$field2		 = $cmb_groal->add_field( array(
			...
			$group_field_id	 = $cmb_groal->add_field( array(
				'id'		 => $prefix . 'demo',
				'type'		 => 'group',
				'options'	 => array(
			...
			$gField1		 = $cmb_groal->add_group_field( $group_field_id, array(
				'name'	 => __( 'Entry Title', 'cmb2' ),
				'id'	 => 'title',
				'type'	 => 'text',
			) );
			$gField2		 = $cmb_groal->add_group_field( $group_field_id, array(
