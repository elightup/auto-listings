...
return [
	...
	'fields'         => [
		[
			'std'  => auto_listings_all_extensions(),
			'type' => 'custom_html',
		],
	],
];

function auto_listings_all_extensions() {
	ob_start()
	?>
	<p class="about-description">
		<?php _e( 'There are a number of premium extensions available at <a href="http://wpautolistings.com/docs/?utm_source=plugin&utm_medium=settings_page&utm_content=extensions" target="_blank">www.wpautolistings.com</a> that will take your automotive website to the next level.', 'auto-listings' ); ?>
	</p>
