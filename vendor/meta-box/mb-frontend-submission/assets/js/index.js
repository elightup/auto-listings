import { isAjax, addLoading, removeLoading, scrollTo, redirect, checkRecaptcha } from './helpers.js';
...
function processForm() {
	...
	function handleSubmitClick( e ) {
		...
		if ( i18n.recaptchaKey ) {
			checkRecaptcha( {
				...
				error: () => displayMessage( i18n.captchaExecuteError )
			} );
		} else {
			submitCallback();
		}
	...
	function displayMessage( message ) {
		message = `<div class="rwmb-confirmation">${message}</div>`;
